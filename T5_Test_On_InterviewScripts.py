import pandas as pd
train_dataframe = pd.read_csv("self_promotion_scores_transcripts.csv")
test_dataframe = pd.read_csv("Test_Transcripts.csv")
...
def T5Trainer(
    train_dataframe, test_dataframe, source_text, target_text, model_params, output_dir="./outputs/"
):
...
#     console.log(f"[Data]: Reading data...\n")
    ...
    train_dataframe = train_dataframe[[source_text, target_text]]
...
train_dataframe["interview"] = "feedback: " + train_dataframe["interview"]
test_dataframe["interview"] = "feedback: " + test_dataframe["interview"]
T5Trainer(
